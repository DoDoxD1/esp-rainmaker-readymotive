...
import com.readymotive.ui.widgets.EspMarkerView;
...
public class TimeSeriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Calendar calendar = Utils.getCalendarForTimeZone(timeZone);
    ...
    private void processTsData(long startTime, long endTime, ArrayList<TsData> tsData) {
        ...
        final Calendar tempCalendar = Utils.getCalendarForTimeZone(timeZone);
